...
def torch_reduce_mean(output, input, dim):
...
def test(
    ...
    print(
        f"Testing reduce_mean on {InfiniDeviceNames[device]} with input_shape:{input_shape}, dim:{dim},"
    ...
    output._torch_tensor = torch_reduce_mean(output.torch_tensor(), input.torch_tensor(), dim)
    ...
    if PROFILE:
        # fmt: off
        profile_operation("PyTorch", lambda: torch_reduce_mean(
...
if __name__ == "__main__":
    ...
    print("\033[92mTest my reduce_mean passed!\033[0m")
