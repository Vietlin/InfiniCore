...
def torch_relu_backward(grad_input, input, grad_output):
    #TODO:
    torch.relu_backward(input=input, out=output)
...
def test(
    ...
    print(
        # TODO:
        f"Testing relu_backward on {InfiniDeviceNames[device]} with "
