...
if __name__ == "__main__":
    ...
    _TEST_CASES_ = [
        # input_shape index_shape, output_shape, dim, input_strides
        ((2, 3, 4), (2, 3, 2), 2, (12, 4, 1)),
        ((2, 3, 4), (2, 3, 2), 2, (30, 5, 1)),
        ((2, 3, 4), (2, 3, 4), 0, None),
        ((11, 2, 2, 4), (11, 2, 2, 4), 0, (40, 20, 4, 1)),
    ]
    _TENSOR_DTYPES_ = [np.float32, np.float16, np.int32, np.int64]
    for dtype in _TENSOR_DTYPES_:
        for input_shape, output_shape, dim, input_strides in _TEST_CASES_:
