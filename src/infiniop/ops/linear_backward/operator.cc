...
#define CALCULATE(CASE, NAMESPACE)                                                                            \
    case CASE:                                                                                                \
        return reinterpret_cast<const op::linear_backward::NAMESPACE::Descriptor *>(desc)->calculate(         \
            workspace,                                                                                        \
            workspace_size,                                                                                   \
            grad_x,                                                                                           \
            grad_w,                                                                                           \
...
#define DELETE(CASE, NAMESPACE)                                                                     \
    case CASE:                                                                                      \
        delete reinterpret_cast<const op::linear_backward::NAMESPACE::Descriptor *>(desc);          \
        return INFINI_STATUS_SUCCESS
