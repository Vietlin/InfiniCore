...
infiniStatus_t Descriptor::calculate(
    ...
    switch (_info.dtype) {
        case INFINI_DTYPE_BOOL:
            CALCULATE_TRIL(uint8_t);
            break;
        case INFINI_DTYPE_U8:
            CALCULATE_TRIL(uint8_t);
            break;
        case INFINI_DTYPE_U16:
            CALCULATE_TRIL(uint16_t);
            break;
        case INFINI_DTYPE_U32:
            CALCULATE_TRIL(uint32_t);
            break;
        case INFINI_DTYPE_U64:
            CALCULATE_TRIL(uint64_t);
            break;
        case INFINI_DTYPE_I8:
            CALCULATE_TRIL(int8_t);
            break;
        case INFINI_DTYPE_I16:
            CALCULATE_TRIL(int16_t);
            break;
        case INFINI_DTYPE_I32:
            CALCULATE_TRIL(int32_t);
            break;
        case INFINI_DTYPE_I64:
            CALCULATE_TRIL(int64_t);
            break;
        case INFINI_DTYPE_F16:
            CALCULATE_TRIL(half);
            break;
        case INFINI_DTYPE_F32:
            CALCULATE_TRIL(float);
            break;
        case INFINI_DTYPE_BF16:
            CALCULATE_TRIL(cuda_bfloat16);
            break;
        default:
