...
#define CALCULATE(CASE, NAMESPACE)                                                                  \
    case CASE:                                                                                      \
        return reinterpret_cast<const op::reduce_mean::NAMESPACE::Descriptor *>(desc)->calculate(   \
            workspace,                                                                              \
            workspace_size,                                                                         \
            output,                                                                                 \
            input,                                                                                  \
...
__C infiniStatus_t
infiniopDestroyReduceMeanDescriptor(infiniopReduceMeanDescriptor_t desc) {
