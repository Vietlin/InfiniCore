...
__C infiniStatus_t infiniopCreateOrDescriptor(
    ...
    case CASE:                                                                  \
        return op::op_or::NAMESPACE::Descriptor::create(                           \
            handle,                                                             \
            reinterpret_cast<op::op_or::NAMESPACE::Descriptor **>(desc_ptr),       \
            c_desc,                                                             \
            {a_desc, b_desc}                                                    \
        )
...
__C infiniStatus_t infiniopGetOrWorkspaceSize(infiniopOrDescriptor_t desc, size_t *size) {
    ...
    case CASE:                                                                            \
        *size = reinterpret_cast<op::op_or::NAMESPACE::Descriptor *>(desc)->workspaceSize(); \
...
__C infiniStatus_t infiniopOr(
    ...
    case CASE:                                                                            \
        return reinterpret_cast<const op::op_or::NAMESPACE::Descriptor *>(desc)->calculate(  \
            workspace,                                                                    \
            workspace_size,                                                               \
            c,                                                                            \
            {a, b},                                                                       \
...
infiniopDestroyOrDescriptor(infiniopOrDescriptor_t desc) {
    ...
    case CASE:                                                                  \
        delete reinterpret_cast<const op::op_or::NAMESPACE::Descriptor *>(desc);   \
        return INFINI_STATUS_SUCCESS
